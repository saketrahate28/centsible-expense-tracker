        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwedById = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SplitDetails", x => new { x.SplitId, x.OwedByUserId });
                    table.ForeignKey(
                        name: "FK_SplitDetails_Splits_SplitId",
                        column: x => x.SplitId,
                        principalTable: "Splits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SplitDetails_Users_OwedById",
                        column: x => x.OwedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
